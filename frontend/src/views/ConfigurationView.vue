...
const form = reactive<ScannerConfig>({ timeframes: [], min_24h_quote_volume: 10000000, volume_ema_period: 12, volume_multiplier: 1.5, min_progress_percent: 10, oi_change_threshold_percent: 0.05, scan_interval_minutes: 5 })
